...
**Versión:** 1.16
**Fecha:** 2026-08-27
**Estado:** **Serie reabierta** — dieciséis reportes (`00` a `15`) **RESUELTOS**, y el `17` **para evaluación**. El `16` está **reservado** para los tres hallazgos ya medidos en la migración de otro destino y todavía no escritos. La serie **no se reanaliza**: ver «Línea de corte». Un reporte nuevo evalúa **SDD 12.1 o posterior**
