...
**Versión:** 1.16
**Fecha:** 2026-08-27
**Estado:** **Serie reabierta** — diecisiete reportes (`00` a `16`) **RESUELTOS**, y el **`18` ABIERTO**, primer reporte contra la mesa de evaluación y el primero que **cierra un ítem diferido del propio framework con medición** (`CHANGELOG.md` 13.7). Los tres hallazgos ya medidos en la migración de `Lab-Geometria` esperan su reporte y conservan el **`17`**. La serie **no se reanaliza**: ver «Línea de corte». Un reporte nuevo evalúa **SDD 12.1 o posterior**
