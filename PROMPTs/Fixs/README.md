...
| `02` | [Fix-Analizar-Reportes-15-16.md](02-Fix-Reportes-15-16/Fix-Analizar-Reportes-15-16.md) | `15` y `16` — el `15` ya resuelto en 10.1 y verificado como tal; el trabajo es el `16`, la exclusión de alcance concedida contra una declaración | **Sin aplicar** |
...
**intervención**, por orden. Lo que sigue es el **rango de reportes que cubre**, y los rangos son
**contiguos**: `00-11`, `12-14`, `15-16`. Cada intervención arranca donde terminó la anterior.

**Un reporte del rango que ya esté resuelto no se reaplica: se verifica y se declara.** Es lo que
pasa con el `15` en la intervención `02`.
...
> [`Fix-Analizar-Reportes-15-17-SUPERADO.md`](02-Fix-Reportes-15-16/Fix-Analizar-Reportes-15-17-SUPERADO.md).
>
