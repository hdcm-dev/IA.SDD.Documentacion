...
| `07` | [Fix-Analizar-Reporte-29.md](07-Fix-Reporte-29/Fix-Analizar-Reporte-29.md) | `29` — el umbral de archivos individuales no dice de qué se cuenta | **Sin aplicar.** No depende de ninguna otra intervención abierta. Su solicitud 6 extiende la decisión a `historias-usuario/`, que tiene la misma contradicción y el reporte no midió |
