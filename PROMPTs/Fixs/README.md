...
| `09` | [Fix-Analizar-Reporte-31.md](09-Fix-Reporte-31/Fix-Analizar-Reporte-31.md) | `31`: el método no expedienta sus casos | **Sin aplicar.** Se numera como la siguiente a la vigente cuando se aplique, probablemente **13.18** sobre la 13.17 preparada en `conocimiento/mesa-de-expertos-a-pedido`. **Trampa principal:** convertir un buen hábito en una ceremonia que nadie completa. La forma mínima se llena en minutos y se verifica enumerando. Lee primero las respuestas al lote E-1 a E-3 del expediente `0001` y alinea la 13.17 §2.3 |
