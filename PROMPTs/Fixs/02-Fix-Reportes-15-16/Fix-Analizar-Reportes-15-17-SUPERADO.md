# Tool-Prompt — Análisis y Fix de los reportes 15, 17

> **Invocación**: Leer y ejecutar `/IA/SDD/IA.SDD.Documentacion/PROMPTs/Fixs/02-Fix-Reportes-15-17/Fix-Analizar-Reportes-15-17.md`
>
> **Overview**: Análisis y Fix de los reportes 15 y 17
...
## Contexto
  ...
  Los dos reportes ya fueron aplicados:

  - `/IA/SDD/IA.SDD.Documentacion/Reportes/15-Las-Exclusiones-Estructurales-Del-Barrido.md`

  - `/IA/SDD/IA.SDD.Documentacion/Reportes/17-La-Exclusion-De-Alcance-Se-Concede-Contra-Una-Declaracion.md`

  Leer también `/IA/SDD/IA.SDD.Documentacion/Reportes/README.md`, que declara cómo se usa cada sección de un reporte dentro de un prompt de intervención, y `/IA/SDD/IA.SDD/CHANGELOG.md`,
